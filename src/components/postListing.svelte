				...
				<div class="flex flex-shrink-0 p-4 pb-0">
					<div class="flex  justify-between">
						...
						<div class=" order-last text-white  opacity-70 hover:opacity-100">
							...
							<div
								id="{i}"
								class=" { post.po_id === deletePop ? '' : 'hidden'} z-10  bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700"
							>
								<ul
				...
				<div class="flex flex-shrink-0 p-4 pb-0">
					<div class="flex  justify-between">
						...
						<div class=" order-last text-white  opacity-70 hover:opacity-100">
							...
							<div
								id="{i}"
								class=" { post.c_id === deletePop ? '' : 'hidden'} z-10  bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700"
							>
								<ul
									class="py-1 text-sm text-gray-700 dark:text-gray-200"
									aria-labelledby="dropdownDefault"
