<aside class="w-2/5 h-12 position-relative 	">
    ...
    <div style="max-width:350px;">
        <div class="overflow-y-auto  fixed  h-screen overflow-y-hidden">
                ...
                <form class="flex items-center">
                    ...
                    <div class="relative w-full">
                        ...
                        <input
                            type="text"
                            id="voice-search"
                            class="text-sm rounded-lg block w-full pl-10 p-1  bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"
                            placeholder="Search..."
                            required
                        />
                ...
                <div class="flex flex-shrink-0">
                    <div class="flex-1 ">
                        <div class="flex items-center w-48">
                            ...
                            <div class="ml-3 mt-3">
                                <p class="text-base leading-6 font-medium text-white">Sonali Hirave</p>
                                <p
